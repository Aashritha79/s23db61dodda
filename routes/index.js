...
router.get('/', function (req, res) {
 res.render('index', { title: 'Airlines App', user : req.user });
});
router.get('/register', function(req, res) {
 res.render('register', { title: 'Airlines App Registration'});
});
...
router.get('/login', function(req, res) {
  res.render('login', { title: 'Airlines App Login', user : req.user });
 });
